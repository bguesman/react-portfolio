  ...
  frag() {
    return (`#version 300 es
      ...
      void main() {
        ...
        float x0 = texture(velocity, vUV - vec2(texelSize.x, 0)).x;
        float x1 = texture(velocity, vUV + vec2(texelSize.x, 0)).x;
        float y0 = texture(velocity, vUV - vec2(0, texelSize.y)).y;
        float y1 = texture(velocity, vUV + vec2(0, texelSize.y)).y;
